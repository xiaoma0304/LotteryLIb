...
Pod::Spec.new do |s|
  ...
  s.homepage     = "https://github.com/xiaoma0304/LotteryLIb"
  ...
  s.author             = { "GN_木头人" => "946193683@qq.com" }
  ...
  s.source       = { :git => "https://github.com/xiaoma0304/LotteryLIb.git", :tag => s.version.to_s }
